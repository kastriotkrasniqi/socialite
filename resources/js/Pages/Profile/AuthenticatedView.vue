        ...
        <div class="max-w-[1065px] mx-auto max-lg:-m-2.5">
            ...
            <div class="bg-white shadow lg:rounded-b-2xl lg:-mt-10 dark:bg-dark2">
                ...
                <div class="relative overflow-hidden w-full lg:h-72 h-48">
                    <img src="/images/avatars/profile-cover.jpg" alt="" class="h-full w-full object-cover inset-0">
                ...
                <div class="p-3">
                    ...
                    <div class="flex flex-col justify-center md:items-center lg:-mt-48 -mt-28">
                        ...
                        <p class="mt-2 text-gray-500 dark:text-white/80"> Family , Food , Fashion , Fourever <a href="#"
                                class="text-blue-500 ml-4 inline-block"> Edit </a></p>

                        <p class="mt-2 max-w-xl text-sm md:font-normal font-light text-center hidden"> I love beauty and
                            emotion. 🥰 I’m passionate about photography and learning. 📚 I explore genres and styles.
                            🌈 I think photography is storytelling. 😊</p>
                    ...
                    <div class="flex items-center gap-2 text-sm py-2 pr-1 max-md:w-full lg:order-2">
                        ...
                        <div>
                            ...
                            <div class="w-[240px]"
                                ...
                                <nav>
                                    <a href="#"> <ion-icon class="text-xl" name="pricetags-outline"></ion-icon> Unfollow
                                    </a>
                                    <a href="#"> <ion-icon class="text-xl" name="time-outline"></ion-icon> Mute story
                                    </a>
                                    <a href="#"> <ion-icon class="text-xl" name="flag-outline"></ion-icon> Report </a>
                                    <a href="#"> <ion-icon class="text-xl" name="share-outline"></ion-icon> Share
                                        profile </a>
                                    <hr>
                                    <a href="#" class="text-red-400 hover:!bg-red-50 dark:hover:!bg-red-500/50">
                                        <ion-icon class="text-xl" name="stop-circle-outline"></ion-icon> Block </a>
                                </nav>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex-1 xl:space-y-6 space-y-3">
                    ...
                    <div class="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
                        ...
                        <div class="relative w-full lg:h-96 h-full sm:px-4">
                            <img src="/images/post/img-2.jpg" alt="" class="sm:rounded-lg w-full h-full object-cover">
                        </div>
                        ...
                        <div class="sm:p-4 p-2.5 flex items-center gap-4 text-xs font-semibold">
                            ...
                            <div class="flex items-center gap-3">
                                <button type="button" class="button-icon bg-slate-200/70 dark:bg-slate-700"> <ion-icon
                    ...
                    <div class="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
                                ...
                                <div class="w-[245px] uk-dropdown"
                                    ...
                                    <nav>
                                        ...
                                        <a href="#"> <ion-icon class="text-xl shrink-0 md hydrated" name="flag-outline"
                                                role="img" aria-label="flag outline"></ion-icon> Report this post </a>
                        ...
                        <div class="sm:px-4 p-2.5 pt-0">
                            <p class="font-normal"> Photography is the art of capturing light with a camera. It can be
                                used to create images that tell stories, express emotions, or document reality. it can
                                be fun, challenging, or rewarding. It can also be a hobby, a profession, or a passion.
                                📷 </p>
                        </div>
                        ...
                        <div class="box p-5 px-6">
                            ...
                            <ul class="text-gray-700 space-y-4 mt-4 text-sm dark:text-white/80">
                                ...
                                <li class="flex items-center gap-3">
                                    ...
                                    <div> Live In <span class="font-semibold text-black dark:text-white"> Cairo , Eygept
                                        </span> </div>
                                </li>
                                <li class="flex items-center gap-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    <div> Studied at <span class="font-semibold text-black dark:text-white"> University
                                            of Turkey </span> </div>
                                </li>
                                <li class="flex items-center gap-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        ...
                        <div class="box p-5 px-6">
                            ...
                            <div class="flex items-ce justify-between text-black dark:text-white">
                                <h3 class="font-bold text-lg"> Friends
                                    <span class="block text-sm text-gray-500 mt-0. font-normal dark:text-white"> 3489
                                        Friends </span>
                                </h3>
