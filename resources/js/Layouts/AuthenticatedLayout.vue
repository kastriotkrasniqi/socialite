            ...
            <div class="flex items-center w-full xl:px-6 px-2 max-lg:gap-10">
                ...
                <div class="2xl:w-[--w-side] lg:w-[--w-side-sm]">
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <div id="logo">
                            <Link href="/">
                            <img src="/images/output.svg" alt="" class="w-28 md:block hidden dark:!hidden">
                            <img src="/images/output.svg" alt="" class="w-20 dark:md:block hidden">
                            <img src="/images/output.svg" class="hidden max-md:block w-20 dark:!hidden" alt="">
                            <img src="/images/output.svg" class="hidden dark:max-md:block w-20" alt="">
                            </Link>
                        </div>
                    ...
                    <div class="max-w-[1220px] mx-auto flex items-center">
                            ...
                            <div
                                ...
                                <nav class="text-sm font-medium text-black dark:text-white">
                                    <a href="#"
                                        ...
                                        <img src="/images/avatars/avatar-2.jpg" class="w-9 h-9 rounded-full">
                                        <div>
                                    ...
                                    <a href="#"
                                        class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10">
                                        <img src="/images/group/group-2.jpg" class="w-9 h-9 rounded-full">
                                        <div>
                                    ...
                                    <a href="#"
                                        class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10">
                                        <img src="/images/group/group-1.jpg" class="w-9 h-9 rounded-full">
                                        <div>
                                            <div> Delicious Foods </div>
                                    ...
                                    <a href="#"
                                        class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10">
                                        <img src="/images/avatars/avatar-6.jpg" class="w-9 h-9 rounded-full">
                                        <div>
                                            <div> John Welim </div>
                                            <div class="text-xs text-blue-500 font-medium mt-0.5"> Friend </div>
                                        </div> <ion-icon name="close"
                        ...
                        <div
                            ...
                            <div class="hidden bg-white p-4 rounded-lg overflow-hidden drop-shadow-xl dark:bg-slate-700 md:w-[324px] w-screen border2"
                                ...
                                <ul class="-m-1 mt-4 pb-1 text-xs text-gray-500 dark:text-white"
                                    ...
                                    <li
                                        ...
                                        <div class="flex-1">
                                            <a href="timeline.html">
                                                <h4 class="font-medium text-sm text-black dark:text-white">Pages
                                                </h4>
                                            </a>
                                            <div class="mt-1 text-xs text-gray-500 dark:text-white">Find and connect
                                                with businesses.</div>
                                        </div>
                                    </li>
                                    <li
                                        class="flex items-center gap-4 hover:bg-secondery rounded-md p-1.5 cursor-pointer dark:hover:bg-white/10">
                                        <img src="/images/icons/event.png" alt="" class="w-7">
                                        <div class="flex-1">
                                            <a href="timeline.html">
                                                <h4 class="font-medium text-sm text-black dark:text-white">Event
                                                </h4>
                                            </a>
                                            <div class="mt-1 text-xs text-gray-500 dark:text-white">Discover fun
                                                activities near you.</div>
                                        </div>
                                    </li>
                                    <li
                                        class="flex items-center gap-4 hover:bg-secondery rounded-md p-1.5 cursor-pointer dark:hover:bg-white/10">
                                        <img src="/images/icons/market.png" alt="" class="w-8 -ml-1">
                                        <div class="flex-1">
                                            <a href="timeline.html">
                                                <h4 class="font-medium text-sm text-black dark:text-white">Market
                                                </h4>
                                            </a>
                                            <div class="mt-1 text-xs text-gray-500 dark:text-white">Find local
                                    ...
                                    <li
                                        ...
                                        <div class="flex-1">
                                            <a href="timeline.html">
                                                <h4 class="font-medium text-sm text-black dark:text-white">Games
                                                </h4>
                                            </a>
                                            <div class="mt-1 text-xs text-gray-500 dark:text-white">Play games with
                                                friends and have fun.</div>
                                        </div>
                                    </li>
                                </ul>
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center gap-2 mb-1">
                                                    <div class="mr-auto text-sm text-black dark:text-white font-medium">
                                                        Jesse Steeve</div>
                                                    <div class="text-xs text-gray-500 dark:text-white/80"> 2 day
                                                    </div>
                                                </div>
                                                <div
                                                    class="font-normal overflow-hidden text-ellipsis text-xs whitespace-nowrap">
                            ...
                            <div class="flex items-center gap-2 hidden">
                                ...
                                <img src="/images/avatars/avatar-2.jpg" alt="" class="w-9 h-9 rounded-full shadow">
                ...
                <div class="pr-4" data-simplebar>
                    ...
                    <nav id="side">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="event.html">
                                    <img src="/images/icons/event.png" alt="messages" class="w-6">
                                    <span> event </span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="groups.html">
                                    <img src="/images/icons/group.png" alt="groups" class="w-6">
                                    <span> Groups </span>
                                </a>
                            </li>
                            <li>
                    ...
                    <div
                        ...
                        <a href="#">
                            <div class="flex items-center gap-2 p-3 px-4 rounded-xl hover:bg-secondery">
                                <img src="/images/avatars/avatar-2.jpg" alt="" class="w-6 rounded-full object-cover">
                                <div> Marin Gray</div>
                            </div>
                        </a>
                        <a href="#">
                            <div class="flex items-center gap-2 p-3 px-4 rounded-xl hover:bg-secondery">
                                <img src="/images/avatars/avatar-7.jpg" alt="" class="w-6 rounded-full object-cover">
                                <div> Alexa Stella</div>
                            </div>
                        </a>
                        <a href="#">
                            <div class="flex items-center gap-2 p-3 px-4 rounded-xl hover:bg-secondery">
                                <img src="/images/avatars/avatar-3.jpg" alt="" class="w-6 rounded-full object-cover">
                                <div> Sarah Ali</div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="space-y -m t-5 p-3 text-sm font-medium h-[280px] overflow-y-auto">
                        ...
                        <a href="#" class="block">
                            <div
                                ...
                                <img src="/images/avatars/avatar-1.jpg" alt="" class="w-7 rounded-full">
                                <div> Jesse Steeve </div>
                            </div>
                        </a>
                        <a href="#" class="block">
                            <div
                                class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="/images/avatars/avatar-2.jpg" alt="" class="w-7 rounded-full">
                        ...
                        <a href="#" class="block">
                            <div
                                class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="/images/avatars/avatar-3.jpg" alt="" class="w-7 rounded-full">
                        ...
                        <a href="#" class="block">
                            <div
                                class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="/images/avatars/avatar-5.jpg" alt="" class="w-7 rounded-full">
                                <div> James Lewis </div>
                            </div>
                        </a>
                        <a href="#" class="block">
                            <div
                                class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="/images/avatars/avatar-4.jpg" alt="" class="w-7 rounded-full">
                                <div> Martin Gray </div>
                            </div>
                        </a>
                        <a href="#" class="block">
                            <div
                                class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="/images/avatars/avatar-6.jpg" alt="" class="w-7 rounded-full">
                                <div> Alexa stella </div>
                            </div>
                        </a>
                        <a href="#" class="block">
        ...
        <div
            ...
            <div class="lg:h-full lg:w-[calc(100vw-400px)] w-full h-96 flex justify-center items-center relative">
                ...
                <div class="relative z-10 w-full h-full">
                    <img src="/images/post/post-1.jpg" alt="" class="w-full h-full object-cover absolute">
                </div>
            ...
            <div
                ...
                <div class="p-5 pb-0">
                    ...
                    <div class="flex gap-3 text-sm font-medium">
                        <img src="/images/avatars/avatar-5.jpg" alt="" class="w-9 h-9 rounded-full">
                        <div class="flex-1">
                ...
                <div class="p-5 h-full overflow-y-auto flex-1">
                    ...
                    <div class="relative text-sm font-medium space-y-5">
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="/images/avatars/avatar-2.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="/images/avatars/avatar-3.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="/images/avatars/avatar-7.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="/images/avatars/avatar-4.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="/images/avatars/avatar-5.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                ...
                <div class="bg-white p-3 text-sm font-medium flex items-center gap-2">
                    ...
                    <img src="/images/avatars/avatar-2.jpg" alt="" class="w-6 h-6 rounded-full">
